...
class Sending(models.Model):
    date_start = models.DateTimeField(verbose_name="Sending start")
    date_end = models.DateTimeField(verbose_name="End of sending")
    ...
    def __str__(self):
        return f"Sending {self.id} from {self.date_start}"
...
class Message(models.Model):
    ...
    def __str__(self):
        return f"Message {self.id} with text {self.sending} for {self.client}"
